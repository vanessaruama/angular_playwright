...
import { AuthResponse } from './autenticacao.service';
...
export class CadastroService {
  ...
  editarCadastro(pessoaUsuaria: PessoaUsuaria): Observable<AuthResponse> {
    return this.http.patch<AuthResponse>(`${this.apiUrl}/auth/perfil`, pessoaUsuaria);
  }
